...
get() {
  ...
  patch -Np1 -d --verbose yajl-$VERS -i ./yajl-$VERS-CVE-2017-16516.patch
  patch -Np1 -d --verbose yajl-$VERS -i ./yajl-$VERS-CVE-2022-24795.patch
  patch -Np1 -d --verbose yajl-$VERS -i ./yajl-$VERS-memory_leak.patch
