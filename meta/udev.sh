...
get() {
  echo "this install script is complicated as fuck because systemd"
  cat > udev_install.sh << 'EOF'
    #!/bin/bash
    wget https://anduin.linuxfromscratch.org/LFS/systemd-man-pages-$VERS.tar.xz
    ...
    tar -xf ../systemd-man-pages-$VERS.tar.xz                        \
